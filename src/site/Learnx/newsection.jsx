    ...
    const taglist=[
...

        {
        ...
        },
          {
            ...
            detail:'Group-IB proprietary training courses are designed to develop unique applied skills',
            icon:'https://www.group-ib.com/wp-content/uploads/w3-1-150x150.png.webp'
        },
         {
            id:5,
            title:"Group-IB unified ecosystem",
...
export function Belowhero(){
    ...
    return(
        <>
            <div className="flex flex-col items-center justify-center ">
                <div className="md:w-[70vw] w-[100vw] text-center">
                    <h1 style={{fontSize:'2.8rem'}}> About Group-IB cyber education center</h1>

                    <span  className="text-gray-400" style={{fontSize:'14px'}}>
                         Group-IB Cyber Education Center was established in 2018. Following the mission of fighting against cybercrime, our center is dedicated to training technical specialists in diverse areas of cybersecurity to facilitate the creation of an effective information security department in any company and enhancing the competencies of law enforcement specialists. 
                    </span>
                    <div className="grid grid-cols-1 md:grid-cols-3 w-[70vw]  gap-7" style={{marginTop:'40px'}} >
                        {Listcard.map((val)=>(
